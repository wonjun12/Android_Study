...
public class PostCreateActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                // TODO: 2023-07-25  form-data로 보내는 방법
                Retrofit retrofit = NetworkClient.getRetrofitClient(PostCreateActivity.this);
    ...
    private void camera(){
        ...
        int permissionCheck = ContextCompat.checkSelfPermission(
                PostCreateActivity.this, android.Manifest.permission.CAMERA);
        ...
        if(permissionCheck != PackageManager.PERMISSION_GRANTED){
            ...
            ActivityCompat.requestPermissions(PostCreateActivity.this,
                    ...
                    1000);
            Toast.makeText(PostCreateActivity.this, "카메라 권한 필요합니다.",
        ...
        // 권한을 이미 허용했다면
            ...
            //카메라가  있다면 실행
            if(i.resolveActivity(PostCreateActivity.this.getPackageManager())  != null  ){
                ...
                // 동일해야함
                Uri fileProvider = FileProvider.getUriForFile(PostCreateActivity.this,
                        "com.wonjun.training13_postingapi.fileprovider", photoFile);
                i.putExtra(MediaStore.EXTRA_OUTPUT, fileProvider);
                startActivityForResult(i, 100);

            } else{
                Toast.makeText(PostCreateActivity.this, "이폰에는 카메라 앱이 없습니다.",
                        Toast.LENGTH_SHORT).show();
            }
        }
    }
    ...
    private boolean checkPermission(){
        int result = ContextCompat.checkSelfPermission(PostCreateActivity.this,
    ...
    private void requestPermission() {
        if(ActivityCompat.shouldShowRequestPermissionRationale(PostCreateActivity.this,
                Manifest.permission.WRITE_EXTERNAL_STORAGE)){
            Log.i("DEBUGGING5", "true");
            Toast.makeText(PostCreateActivity.this, "권한 수락이 필요합니다.",
                    Toast.LENGTH_SHORT).show();
        }else{
        ...
        switch (requestCode) {
            case 1000: { //아까 카메라 권한이  설정안되어 있을때 1000번으로 보냈었음
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    Toast.makeText(PostCreateActivity.this, "권한 허가 되었음",
                            Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(PostCreateActivity.this, "아직 승인하지 않았음",
                            Toast.LENGTH_SHORT).show();
                }
                break;
            }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if(requestCode == 100 && resultCode == RESULT_OK){ //카메라
            ...
            imgAdd.setImageBitmap(photo); // 보여줌
...
//                String cacheFilePath = file.getAbsolutePath( );
                ...
                imgAdd.setScaleType(ImageView.ScaleType.CENTER_INSIDE);
